...
//       <h1 className="text-3xl font-bold mb-4 text-gray-800">Delivery Information</h1>
//       <p className="mb-4 text-gray-700">
//         We aim to deliver your orders as quickly as possible. Delivery timelines may vary depending on location and availability.
//       </p>
...
//       <p className="mb-4 text-gray-700">
//         Once your order is shipped, you will receive a tracking number via email/SMS. You can track your order on our website or courier partner's site.
//       </p>
//       <h2 className="text-xl font-semibold mb-2">Delivery Issues</h2>
//       <p className="mb-4 text-gray-700">
//         If your order is delayed or lost, please contact our support team. We will assist you in resolving delivery issues promptly.
//       </p>
//     </div>
//   );
// }
